...
ui <- dashboardPage(skin = "green",
                    ...
                    dashboardSidebar(width = 250,
                                     sidebarMenu(
                                       menuItem("Popularity Maps", tabName = "popularity", icon = icon("map")),
                    ...
                    dashboardBody(
                      tabItems(
                        tabItem(tabName = "popularity",
                                ...
                                checkboxGroupInput("feds", "Choose Federations:", allFeds, selected = allFeds, inline = TRUE),
                                checkboxGroupInput('type','Types', c('Tested', 'Untested'), selected =  c('Tested', 'Untested'),inline = TRUE),
                        ...
                        tabItem(tabName = "drugs",
                                ...
                                checkboxGroupInput('drug_equipment','Equipment', equipments, selected = equipments, inline = TRUE),
                                br(),
